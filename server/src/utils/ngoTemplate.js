module.exports.ngoTemplate = (name) => {
                  ...
                  >
                    <div style="width: 100% !important">
                      ...
                      >
                        ...
                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 35px; font-family: Arial, sans-serif"><![endif]-->
                        <div
                          style="
                            color: #555555;
                            ...
                            >
                              <span style="color: #2a272b"
                                ><span style="font-size: 16px"
                                  >Your NGO will be provided with <b>${name}</b></span
                                ></span
                              >
                            </p>
                          </div>
